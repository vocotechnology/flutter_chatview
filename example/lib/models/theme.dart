...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    Color textFieldBackgroundColor = const Color(0xff252525),
    ...
    Color repliedMyMessageColor = Colors.blue,
    Color repliedInComingMessageColor = const Color(0xff9f85ff),
    ...
    Color replyMicIconColor = Colors.white,
          ...
          repliedMyMessageColor: repliedMyMessageColor,
          repliedInComingMessageColor: repliedInComingMessageColor,
...
class LightTheme extends AppTheme {
  LightTheme({
    ...
    Color replyDialogColor = const Color(0xffF0EFEF),
    ...
    Color textFieldBackgroundColor = const Color(0xffF0EFEF),
    Color outgoingChatBubbleColor = Colors.blue,
    Color inComingChatBubbleColor = const Color(0xffF0EFEF),
    Color inComingChatBubbleTextColor = Colors.black,
    Color repliedMyMessageColor = Colors.blue,
    Color repliedInComingMessageColor = const Color.fromARGB(255, 116, 115, 115),
    ...
    Color verticalBarColor = const Color(0xffF0EFEF),
