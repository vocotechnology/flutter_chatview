      ...
      body: SafeArea(
        ...
        child: ChatView(
          ...
          repliedMessageConfig: RepliedMessageConfiguration(
            repliedMyMessageColor: theme.repliedMyMessageColor,
            repliedInComingMessageColor: theme.repliedInComingMessageColor,
            verticalBarColor: theme.verticalBarColor,
            repliedMsgAutoScrollConfig: const RepliedMsgAutoScrollConfig(
              enableHighlightRepliedMsg: true,
              highlightColor: Color(0xffF0EFEF),
              highlightScale: 1.1,
            ),
